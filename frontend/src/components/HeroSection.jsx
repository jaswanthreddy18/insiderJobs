    ...
    return (
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-10 items-center '>
                ...
                <p className='text-gray-400 w-[500px]'>Your dream job is out there — and it's waiting for someone exactly like you. Whether you're chasing a lifelong goal or looking to make your next bold move, we make it simple: search, apply, and take control of your career. The future you've imagined starts with one step. Take it today!</p>
